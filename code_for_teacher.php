...
<div class="tab-content"> <?php 
    ...
    <div class="tab-pane" id=<?php echo $row['fname']?>>
        ...
        <input id="file_selected" name="file_selected" type="radio" value="<?php echo $row1['ppath']?>" onclick="javascript:loading(this.value);">&nbsp;<?php echo $row1['pname']?>
       <?php }
            ?>
        <br>
        </form>
...
<div class="col-md-6">
    ...
    <textarea id="code" name="code" class="form-control" rows="15" disabled></textarea><br>
